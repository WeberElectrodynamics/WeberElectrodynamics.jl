...
Agent 6 (`_research/Topology/FourBodyTwoPlusTwoMinus/06_poincare_kam/poincare_summary.csv`)
...
julia --project=. _research/Topology/FourBodyTwoPlusTwoMinus/07_lyapunov_chaos/lyapunov.jl
```
