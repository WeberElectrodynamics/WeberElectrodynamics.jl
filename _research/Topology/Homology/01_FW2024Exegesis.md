...
- `_research/Investigations/CriticalRadiusAndLikeChargeAttraction.md`
- `_research/Investigations/AngularMomentumRegularization.md`
- `_research/Investigations/TetheringImpossibility.md`
- `_research/Topology/FourBodyTwoPlusTwoMinus/10_floer_symplectic/NOTES.md`
- `_research/Topology/FourBodyTwoPlusTwoMinus/12_homology_morse/NOTES.md`
...
| 4-body 2+/2- periodic orbit search | `_research/Topology/FourBodyTwoPlusTwoMinus/` | Far beyond FW2024 scope. Only 1 orbit found (breathing square, super-critical, unstable). |
