...
**Scope:** `/research/homology/`
**Prior study:** `/research/FourBodyTwoPlusTwoMinus/REPORT.md` (2026-04-14)
...
The prior 14-agent study (`research/FourBodyTwoPlusTwoMinus/REPORT.md`) identified several promising candidates that this study has re-evaluated:
...
Ranked by expected payoff. See also `16_final_report/open_problems.md`.
...
Individual NOTES.md files in `01_fw2024_exegesis/` through `15_synthesis/`, with scripts, data files, and catalogs in each directory.

### Companion files

- `15_synthesis/master_orbit_catalog.csv` -- 45-entry catalog of all orbits found
- `15_synthesis/existence_accounting.md` -- topology prediction vs numerical reality
- `15_synthesis/open_conjectures.md` -- status of conjectures C1-C3, C11, C15a-e
- `16_final_report/open_problems.md` -- prioritized open problems list
