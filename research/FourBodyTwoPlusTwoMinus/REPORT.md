...
- A breathing-square periodic orbit *does exist* (Agent 5, [05_periodic_orbits/NOTES.md](05_periodic_orbits/NOTES.md)) with period $T\approx 11.78$, $E\approx-0.646$, energy drift $\sim 0$, but Floquet spectral radius $|\lambda|_{\max}\approx 228$ per period — violently unstable, consistent with the linear exponent.
- The single Poincaré/KAM survivor is `rhombus(a=1.5, b=1.15, η=0.75, rotating)` (Agent 6, [06_poincare_kam/NOTES.md](06_poincare_kam/NOTES.md)); this is our best torus candidate.
- **Every sub-Weber-radius experiment failed** (Agent 8, [08_sub_weber_radius/NOTES.md](08_sub_weber_radius/NOTES.md)), reproducing the Frauenfelder–Weber 2024 topological obstruction: $\ell\ne 0$ spirals are non-regularizable.
...
Output: [02_symmetry_reduction/](02_symmetry_reduction/)
...
Output: [03_config_space_topology/](03_config_space_topology/)
...
Output: [04_equilibria_normal_forms/](04_equilibria_normal_forms/)
...
Output: [05_periodic_orbits/](05_periodic_orbits/)
...
Output: [06_poincare_kam/](06_poincare_kam/)
...
Output: [07_lyapunov_chaos/](07_lyapunov_chaos/)
...
Output: [08_sub_weber_radius/](08_sub_weber_radius/)
...
Output: [09_ftl_regime/](09_ftl_regime/)
...
Output: [10_floer_symplectic/](10_floer_symplectic/)
...
Output: [11_contact_reeb/](11_contact_reeb/)
...
Output: [12_homology_morse/](12_homology_morse/)
...
Output: [13_zollner_comparison/](13_zollner_comparison/)
...
Output: [14_numerical_atlas/](14_numerical_atlas/)

50-row master CSV ([atlas.csv](14_numerical_atlas/atlas.csv)) with $q_0, p_0$ JSON, retcodes, drift, tags. `reproduce.jl` (144 lines, pure Julia) rebuilds any subset via the shared harness. 40/50 rows are fully materialised; 10 are parametric references.
...
- [06_poincare_kam/FOLLOWUP_long_rhombus.md](06_poincare_kam/FOLLOWUP_long_rhombus.md) — §16 item 1
- [08_sub_weber_radius/FOLLOWUP_symmetric_double_orbiter.md](08_sub_weber_radius/FOLLOWUP_symmetric_double_orbiter.md) — §16 item 2
...
- Shared code: [shared/ic_generators.jl](shared/ic_generators.jl), [shared/metrics.jl](shared/metrics.jl), [shared/run_survey.jl](shared/run_survey.jl)
- Agent outputs: [01_symbolic/](01_symbolic/) … [14_numerical_atlas/](14_numerical_atlas/)
