...
Weber's "planetary model of the atom" combines a sub-critical like-charge pair with orbiting unlike charges (see [CriticalRadiusAndLikeChargeAttraction.md](../investigations/CriticalRadiusAndLikeChargeAttraction.md)). The simplest realisation is a three-body system.
