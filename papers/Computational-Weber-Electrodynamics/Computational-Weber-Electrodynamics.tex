...
\begin{abstract}
    We describe the numerical simulation of $n$-body systems in Weber's electrodynamics. We derive the general Hamiltonian and equations of motion for $n$ particles and apply a symplectic integrator. This method enables investigations of the kinemtics and dynamics given some initial conditions and the numerical verification of conserved quantities like energy, momentum and angular momentum. Furthermore, it opens the door to exploring alternative models for electromagnetic radiation and bound states of like charges below Weber's critical radius.
\end{abstract}
