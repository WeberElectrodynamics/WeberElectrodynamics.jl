...
Perhaps the most promising direction for future research lies in the remarkable fact that Weber's force law admits \textit{attraction between like charges} below a critical separation $\rho = q_1 q_2/(\mu c^2)$, where $\mu = m_1 m_2 / (m_1 + m_2)$ is the reduced mass. At this critical radius, the effective inertial mass of both charges $\mu_{\text{eff}} = \mu(1 - \rho/r)$ changes sign. For $r < \rho$, the particles respond to the still-repulsive Coulomb force as if they had negative inertia, accelerating toward each other rather than away. Weber himself identified this phenomenon in his Sixth Memoir (1871) and called the resulting bound oscillatory state a ``molecular movement''~\citep{assis-weber-vol4}.
