...
See [CollisionBounceRegularization](https://github.com/WeberElectrodynamics/WeberElectrodynamics.jl/blob/main/_research/exploratory/CollisionBounceRegularization.md) for details.
