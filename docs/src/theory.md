...
- [Initial Conditions](https://github.com/WeberElectrodynamics/WeberElectrodynamics.jl/blob/main/theory/InitialConditions.md) — constructing valid q0/p0 for target orbits: two-body, symmetric N-body polygon, 3D rigid rotation, and Zöllner case; circular velocity, η_v velocity scale, energy–angular-momentum parameterisation
...
- [Zöllner Electrogravitational Theory](https://github.com/WeberElectrodynamics/WeberElectrodynamics.jl/blob/main/theory/ZollnerElectrogravitationalTheory.md) — κ mismatch derivation, emergent gravitational attraction from electrical dyads, comparison with Newtonian gravity
