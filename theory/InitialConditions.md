...
| --- | --- | --- |
| $0$ | radial free fall | $-\lvert k\rvert/r_0$ |
| $(0, 1)$ | elliptical, sub-circular | $E < E_{\mathrm{circ}}$ |
| $1$ | circular | $E_{\mathrm{circ}} = -\lvert k\rvert/(2r_0)$ |
...
Weber's "planetary model of the atom" combines a sub-critical like-charge pair with orbiting unlike charges. The simplest realisation is a three-body system.
...
| Two-body attractive, fixed $r_0$, fix $E$ | $r_0 < \lvert k\rvert/\lvert E\rvert$ | $r_0 = \lvert k\rvert/\lvert E\rvert$ (zero velocity) |
| $N$-body polygon, $\eta$ | $\eta < 1$ | $\eta = 1$, $E = 0$ |
| $N$-body polygon, fix $E < 0$ | $T_0 < \lvert U_0\rvert$ | $T_0 = \lvert U_0\rvert$, $E = 0$ |
...
| --- | --- | --- |
| 2-body attractive, sep.$r_0$ | $k/r_0$ | $\eta_v\sqrt{\lvert k\rvert/(\mu r_0)}$ |
| 4-body square, radius $R$ | $(Q^2/R)(1-2\sqrt{2})$ | $\sqrt{\eta\lvert U_0\rvert/(2m)}$ |
| 6-body hexagon, radius $R$ | $(Q^2/R)(-\tfrac{15}{2}+2\sqrt{3})$ | $\sqrt{\eta\lvert U_0\rvert/(3m)}$ |
